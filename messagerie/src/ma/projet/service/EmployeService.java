...
public int getEmployeeIdByName(String nom, String prenom) {
    try {
        String query = "SELECT id FROM employe WHERE nom = ? AND prenom = ?";
    ...
    return -1; // Retourne -1 si l'employé n'est pas trouvé (à gérer en conséquence)
}
